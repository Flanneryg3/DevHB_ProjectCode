...
for sub in ${w1_subjects}; do
	...
	rm *${sub}sess001-SID-PPI-VS-x1D*
	rm *${sub}sess001-SID-PPI-VS-REML*
	rm *SID-PPI-VS-xjpeg*
	...
	-stim_file 10 sub-${sub}sess001-B_VS-concat_Neur_t.1D -stim_label 10 VS \
	-stim_file 11 sub-${sub}sess001-B_VS-Inter_Rhit_concat.1D -stim_label 11 RhitVS \
	-stim_file 12 sub-${sub}sess001-B_VS-Inter_Rmiss_concat.1D -stim_label 12 RmissVS \
	-stim_file 13 sub-${sub}sess001-B_VS-Inter_Phit_concat.1D -stim_label 13 PhitVS \
	-stim_file 14 sub-${sub}sess001-B_VS-Inter_Pmiss_concat.1D -stim_label 14 PmissVS \
	-num_glt 12 \
	...
	-rout \
	-tout -xsave -xjpeg sub-${sub}sess001-SID-PPI-VS-xjpeg -x1D sub-${sub}sess001-SID-PPI-VS-x1D

	3dREMLfit -matrix sub-${sub}sess001-SID-PPI-VS-x1D \
	-input "sub-${sub}sess001_task-Shapes1_norm+tlrc sub-${sub}sess001_task-Shapes2_norm+tlrc" \
	-mask ${datapath}/sub-${sub}sess001/func/sub-${sub}sess001_task-Shapes1_space-MNI152NLin2009cAsym_desc-brain_mask_2mm+tlrc \
	-rout \
	-tout -Rbuck sub-${sub}sess001-SID-PPI-VS-REML -Rvar sub-${sub}sess001-SID-PPI-VS-REMLvar -verb $*
done
...
for sub in ${w2_subjects}; do
	...
	rm *${sub}sess002-SID-PPI-VS-x1D*
	rm *${sub}sess002-SID-PPI-VS-REML*
	rm *SID-PPI-VS-xjpeg*
	...
	-stim_times 8 neutral_cue.txt SPMG1 -stim_label 8 Ncue \
	-stim_times 9 punish_cue.txt SPMG1 -stim_label 9 Pcue \
	-stim_file 10 sub-${sub}sess002-B_VS-concat_Neur_t.1D -stim_label 10 VS \
	-stim_file 11 sub-${sub}sess002-B_VS-Inter_Rhit_concat.1D -stim_label 11 RhitVS \
	-stim_file 12 sub-${sub}sess002-B_VS-Inter_Rmiss_concat.1D -stim_label 12 RmissVS \
	-stim_file 13 sub-${sub}sess002-B_VS-Inter_Phit_concat.1D -stim_label 13 PhitVS \
	-stim_file 14 sub-${sub}sess002-B_VS-Inter_Pmiss_concat.1D -stim_label 14 PmissVS \
	-num_glt 12 \
	-gltsym 'SYM: +Rhit -Rmiss' \
	-glt_label 1 Rhit-Rmiss \
	-gltsym 'SYM: +Phit -Pmiss' \
	...
	-glt_label 12 Rcue-Pcue \
	-rout \
	-tout -xsave -xjpeg sub-${sub}sess002-SID-PPI-VS-xjpeg -x1D sub-${sub}sess002-SID-PPI-VS-x1D

	3dREMLfit -matrix sub-${sub}sess002-SID-PPI-VS-x1D \
	-input "sub-${sub}sess002_task-Shapes1_norm+tlrc sub-${sub}sess002_task-Shapes2_norm+tlrc" \
	-mask ${datapath}/sub-${sub}sess002/func/sub-${sub}sess002_task-Shapes1_space-MNI152NLin2009cAsym_desc-brain_mask_2mm+tlrc \
	-rout \
	-tout -Rbuck sub-${sub}sess002-SID-PPI-VS-REML -Rvar sub-${sub}sess002-SID-PPI-VS-REMLvar -verb $*
done
...
for sub in ${w3_subjects}; do
	...
	rm *${sub}sess003-SID-PPI-VS-x1D*
	rm *${sub}sess003-SID-PPI-VS-REML*
	rm *SID-PPI-VS-xjpeg*
	...
	-stim_times 8 neutral_cue.txt SPMG1 -stim_label 8 Ncue \
	-stim_times 9 punish_cue.txt SPMG1 -stim_label 9 Pcue \
	-stim_file 10 sub-${sub}sess003-B_VS-concat_Neur_t.1D -stim_label 10 VS \
	-stim_file 11 sub-${sub}sess003-B_VS-Inter_Rhit_concat.1D -stim_label 11 RhitVS \
	-stim_file 12 sub-${sub}sess003-B_VS-Inter_Rmiss_concat.1D -stim_label 12 RmissVS \
	-stim_file 13 sub-${sub}sess003-B_VS-Inter_Phit_concat.1D -stim_label 13 PhitVS \
	-stim_file 14 sub-${sub}sess003-B_VS-Inter_Pmiss_concat.1D -stim_label 14 PmissVS \
	-num_glt 12 \
	-gltsym 'SYM: +Rhit -Rmiss' \
	-glt_label 1 Rhit-Rmiss \
	-gltsym 'SYM: +Phit -Pmiss' \
	...
	-glt_label 12 Rcue-Pcue \
	-rout \
	-tout -xsave -xjpeg sub-${sub}sess003-SID-PPI-VS-xjpeg -x1D sub-${sub}sess003-SID-PPI-VS-x1D

	3dREMLfit -matrix sub-${sub}sess003-SID-PPI-VS-x1D \
	-input "sub-${sub}sess003_task-Shapes1_norm+tlrc sub-${sub}sess003_task-Shapes2_norm+tlrc" \
	-mask ${datapath}/sub-${sub}sess003/func/sub-${sub}sess003_task-Shapes1_space-MNI152NLin2009cAsym_desc-brain_mask_2mm+tlrc \
	-rout \
	-tout -Rbuck sub-${sub}sess003-SID-PPI-VS-REML -Rvar sub-${sub}sess003-SID-PPI-VS-REMLvar -verb $*
done
